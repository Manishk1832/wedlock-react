    ...
    <div className="w-100 7xl:h-[60rem] 8xl:h-[60rem]  8xl:px-32  3xl:h-[67rem] bg-[#E6F2F7] 3xl:px-56 xl:px-10  5xl:py-4 7xl:px-36">
      <div className="md:space-y-10 relative min-h-screen  md:px-20 md:py-10 3xl:py-16 3xl:pt-28  p-8 container m-auto 5xl:h-[20rem]">
        ...
        <div className="flex  justify-left gap-10 items-center my-10">
          <div
            className="rounded-full cursor-pointer hover:bg-[#009BDA] hover:text-white text-[#838E9E] p-4 text-[24px]"
            style={{
        ...
        <div className="flex flex-col items-left gap-10 ">
          <div className="grid md:grid-cols-6 grid-cols-3 gap-3">
            {Profile.map((P, index) => (
              <div
                key={index}
                className="flex flex-col items-center gap-2 hover:shadow-2xl hover:rounded-xl"
              >
                <img src={P.img} alt="p1" className="rounded-full" />
                <h1>{P.ct}</h1>
              </div>
            ))}
          </div>
          <div
            className="  flex justify-end text-[24px] text-[#009BDA] relative "
            style={{ fontFamily: "Proxima-Nova-regular", lineHeight: "42px" }}
          >
          </div>
        </div>
      </div>
